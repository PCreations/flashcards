...
Feature: Starting a session for a specific box
  ...
  Scenario Outline: The current player starts a session the <todaySessionDate> while the last session was played at <lastPlayedAt> for his box "Capitals of the World"
